...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-0">
      <span class="text-muted fw-light">News /</span><span class="fw-medium"> Edit News</span>
    </h4>
      <!-- Add Product -->
        ...
        <div class="col-12 col-lg-10">
          ...
          <div class="card mb-4">
            <div class="card-header">
              <h5 class="card-tile mb-0">Edit News</h5>
            </div>
            <div class="card-body">
            ...
            <form action="{{ route('update.news',$news->id) }}" method="post" enctype="multipart/form-data" id="form_validation">
                @csrf
              <div class="row mb-3 ">
              ...
              <div class="mb-3">
                ...
                <textarea
                  ...
                  name="description_en"
                  aria-label="English Description">{{ $news->description_en }}</textarea>
              </div>
              <div class="mb-3">
                ...
                <textarea
                  ...
                  name="description_ar"
                  aria-label="Arabic Description">{{ $news->description_ar }}</textarea>
              </div>
              <div class="mb-3">
                ...
                <textarea
                  ...
                  aria-label="Kurdish Sorani Description">{{ $news->description_ckb }}</textarea>
              </div>
              <div class="mb-3">
                ...
                <textarea
                  ...
                  name="description_ku"
                  aria-label="Kurdish Badini Description">{{ $news->description_ku }}</textarea>
              </div>
            ...
            <div class="mb-s">
                ...
                <div class="d-flex align-items-start align-items-sm-center gap-4 flex-wrap">
                    <img
                      src="{{ !empty($news->image)?asset($news->image):'https://via.placeholder.com/400x400&text=400x400' }}"
                      alt="sponsor-logo"
