...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-0">
      <span class="text-muted fw-light">Poll / Poll Category /</span><span class="fw-medium"> Edit Poll Category</span>
    </h4>
      <!-- Add Product -->
        ...
        <div class="col-12 col-lg-10">
          ...
          <div class="card mb-4">
            <div class="card-header">
              <h5 class="card-tile mb-0">Edit Poll Category</h5>
            </div>
            <div class="card-body">
            ...
            <form action="{{ route('update.poll.category',$data->id) }}" method="post" enctype="multipart/form-data" id="form_validation">
                @csrf
              <div class="mb-3 ">
              ...
              <div class="col-12 col-sm">
               ...
               <div class="d-flex align-items-start align-items-sm-center gap-4">
                   <img
                   src="{{ !empty($data->image)?asset($data->image):'https://via.placeholder.com/150x150&text=poll-category-logo' }}"
                   alt="user-avatar"
