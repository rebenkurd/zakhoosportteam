            ...
            $(document).on('click', '.restore-btn', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var url = "{{ route('restore.poll.category', ':id') }}".replace(':id', id);
...
<script>
    $(function(){
        ...
        var tableTitle = "List Of Recycle Poll Categoriess";
        var columnNumber = [1,2,3];
        var url = "{{ route('recycle.poll.category') }}";
        let table =$('#table');
        ...
        $(document).on('click', '.restore-all', function(e){
            ...
            Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var url = "{{ route('poll.category.restore.multiple') }}";
                        $.ajax({
                            url: url,
                            type: 'POST',
                            data: {
