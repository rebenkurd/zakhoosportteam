...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click', '.status-toggle', function(e){
            ...
            var url = "{{ route('poll.category.status', ':id') }}".replace(':id', id);
            ...
            $(document).on('click', '.delete-btn', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var url = "{{ route('delete.poll.category', ':id') }}".replace(':id', id);
            ...
            $(document).on('click', '.ban-btn', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var url = "{{ route('ban.poll.category', ':id') }}".replace(':id', id);
...
<script>
    $(document).ready(function(){
            $(document).on('click', '.create-new', function (e) {
                e.preventDefault();
                var url = "{{ route('add.poll.category') }}";
                $.ajax({
                    url: url,
                    type: 'get',
                    success: function(response) {
...
<script>
    $(function(){
        ...
        var addButton = "Add New Poll Category";
        var tableTitle = "List Of Poll Categories";
        var columnNumber = [1,2,3];
        var url = "{{ route('list.poll.category') }}";
        let table =$('#table');
        ...
        $(document).on('click', '.delete-all', function(e){
            ...
            Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var url = "{{ route('poll.category.delete.multiple') }}";
                        $.ajax({
                            url: url,
                            type: 'POST',
                            data: {
        ...
        $(document).on('click', '.ban-all', function(e){
            ...
            Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var url = "{{ route('poll.category.ban.multiple') }}";
                        $.ajax({
                            url: url,
                            type: 'POST',
                            data: {
