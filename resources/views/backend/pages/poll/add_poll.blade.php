...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-0">
      <span class="text-muted fw-light">Poll /</span><span class="fw-medium"> Add New Poll</span>
    </h4>
      <!-- Add Product -->
        ...
        <div class="col-12 col-lg-10">
          ...
          <div class="card mb-4">
            <div class="card-header">
              <h5 class="card-tile mb-0">Add New Poll</h5>
            </div>
            <div class="card-body">
            ...
            <form action="{{ route('store.poll') }}" method="post" enctype="multipart/form-data" id="form_validation">
                @csrf
                <div class="mb-3">
                      ...
                      <div data-repeater-list="options">
                        <div data-repeater-item>
                          <div class="form-group row mb-5">
                            ...
                            <div class="col-md-3">
                              <input name="options[][video_url]" type="text" class="form-control mb-2" placeholder="Video Url">
                            </div>
                            <div class="col-md-2">
