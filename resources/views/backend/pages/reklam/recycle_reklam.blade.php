                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><a href="javascript:void(0);" class="dropdown-item " id="restore-btn" data-id="{{ $reklam->id }}"><i class="ti ti-restore"></i> Restore</a></li>
            ...
            $(document).on('click', '#restore-btn', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var url = "{{ route('restore.reklam', ':id') }}".replace(':id', id);
