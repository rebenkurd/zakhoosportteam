...
<script>
    $(function(){
        ...
        var addButton = "Add New Sponsor";
        var tableTitle = "List Of Sponsors";
        var columnNumber = [1,2,3,4];
        var url = "{{ route('list.sponsor') }}";
        let table =$('#table');
        ...
        $(document).on('click', '.delete-all', function(e){
            ...
            Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var url = "{{ route('sponsor.delete.multiple') }}";
                        $.ajax({
                            url: url,
                            type: 'POST',
                            data: {
        ...
        $(document).on('click', '.ban-all', function(e){
            ...
            Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var url = "{{ route('sponsor.ban.multiple') }}";
                        $.ajax({
                            url: url,
                            type: 'POST',
                            data: {
