                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:void(0);" class="status-toggle" data-id="{{ $sponsor->id }}" data-status="inactive"><span class="badge bg-label-success">Active</span></a>
                            @else
                                <a href="javascript:void(0);" class="status-toggle" data-id="{{ $sponsor->id }}" data-status="active"><span class="badge bg-label-danger">Inactive</span></a>
                            @endif
                            </td>
                            <td>
                                {{ $sponsor->type }}
                            ...
                            <td>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><a href="javascript:void(0);" class="dropdown-item " id="ban-btn" data-id="{{ $sponsor->id }}"><i class="ti ti-ban"></i> Ban</a></li>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click', '.status-toggle', function(e){
            ...
            var url = "{{ route('sponsor.status', ':id') }}".replace(':id', sponsorId);
            ...
            $(document).on('click', '#ban-btn', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var sponsorId = banBtn.data('id'); // Use stored reference
                        var url = "{{ route('ban.sponsor', ':id') }}".replace(':id', sponsorId);
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                // Assuming the response contains updated status information
                                banBtn.closest('tr').remove(); // Use stored reference
                            },
                            error: function(xhr, error) {
                                toastr.error(error);
                            }
