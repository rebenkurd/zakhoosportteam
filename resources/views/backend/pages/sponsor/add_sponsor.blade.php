...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-0">
      <span class="text-muted fw-light">Sponsor /</span><span class="fw-medium"> Add New Sponsor</span>
    </h4>
      <!-- Add Product -->
        ...
        <div class="col-12 col-lg-10">
          ...
          <div class="card mb-4">
            <div class="card-header">
              <h5 class="card-tile mb-0">Add New Sponsor</h5>
            </div>
            <div class="card-body">
            ...
            <form action="{{ route('store.sponsor') }}" method="post" enctype="multipart/form-data" id="form_validation">
                @csrf
              <div class="row mb-3 ">
                <div class="col">
            ...
            <div class="mb-3">
                ...
                <div class="d-flex align-items-start align-items-sm-center gap-4">
                    <img
                      src="https://via.placeholder.com/150x150&text=sponsor-logo"
                      alt="sponsor-logo"
