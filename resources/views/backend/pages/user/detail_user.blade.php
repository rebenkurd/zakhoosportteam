            ...
            <div class="flex-grow-1 mt-3 mt-sm-5">
              <div
                ...
                <div class="user-profile-info">
                  <h4>{{ Illuminate\Support\Str::of($user->name)->apa() }}</h4>
          ...
          <div class="card-body">
            ...
            <ul class="list-unstyled mb-4 mt-3">
              <li class="d-flex align-items-center mb-3">
                ...
                ><span class="fw-medium mx-2 text-heading">Full Name:</span> <span class="text-capitalize">{{ Illuminate\Support\Str::of($user->name)->apa() }}</span>
              </li>
              <li class="d-flex align-items-center mb-3">
              ...
              <li class="d-flex align-items-center mb-3">
                ...
                ><span class="fw-medium mx-2 text-heading">Status:</span> <span>{!! $user->status == 'active' ? '<span class="badge bg-label-success">Active</span>':'<span class="badge bg-label-danger">Inactive</span>' !!}</span>
              </li>
              <li class="d-flex align-items-center mb-3">
                <i class="ti ti-crown text-heading"></i
                ><span class="fw-medium mx-2 text-heading">Role:</span> <span class="text-capitalize">{{ $user->getRoleNames()->first() }}</span>
              </li>
            </ul>
