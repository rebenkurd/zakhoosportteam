...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-0">
      <span class="text-muted fw-light">User /</span><span class="fw-medium"> Edit User</span>
    </h4>
      <!-- Add Product -->
        ...
        <div class="col-12 col-lg-10">
          ...
          <div class="card mb-4">
            <div class="card-header">
              <h5 class="card-tile mb-0">Edit User</h5>
            </div>
            <div class="card-body">
            ...
            <form action="{{ route('update.user',$user->id) }}" method="post" enctype="multipart/form-data" id="form_validation">
                @csrf
              <div class="row mb-3 ">
                <div class="col">
            ...
            <div class="col">
                ...
                <select id="role" name="role" class="select2 form-select" data-allow-clear="true">
                    ...
                    @forelse ( $roles as $role )
                        <option value="{{ $role->name }}"  {{ $user->hasRole($role->name) ? 'selected' : ''}} >{{ Illuminate\Support\Str::of($role->name)->apa() }}</option>
                    @empty
                ...
                <div class="mb-3">
                   ...
                   <div class="d-flex align-items-start align-items-sm-center gap-4">
                       <img
                         src="{{ !empty($user->image) ? asset($user->image) : 'https://via.placeholder.com/150x150' }}"
                         alt="user-avatar"
