...
<script>
    $(function(){
        ...
        var addButton = "Add New Player";
        var tableTitle = "List Of Players";
        var columnNumber = [1,2,3,4,5];
        var url = "{{ route('list.player') }}";
        let table =$('#table');
        ...
        $(document).on('click', '.delete-all', function(e){
            ...
            Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var url = "{{ route('player.delete.multiple') }}";
                        $.ajax({
                            url: url,
                            type: 'POST',
                            data: {
        ...
        $(document).on('click', '.ban-all', function(e){
            ...
            Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var url = "{{ route('player.ban.multiple') }}";
                        $.ajax({
                            url: url,
                            type: 'POST',
                            data: {
